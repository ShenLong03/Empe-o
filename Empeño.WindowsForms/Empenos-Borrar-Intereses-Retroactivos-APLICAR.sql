/* =====================================================================================
   BORRADO DE INTERESES RETROACTIVOS MAL GENERADOS  --  VERSION QUE APLICA (COMMIT)
   -------------------------------------------------------------------------------------
   ...
   COMO USARLO
     ...
     Paso 2  INSTALAR PRIMERO la version 2.5.23. Si se corre este script con la
             version vieja instalada, el proximo login vuelve a crear todo.
     Paso 3  Correr este script. APLICA LOS CAMBIOS: termina en COMMIT.
   ===================================================================================== */
...
/* ESTA VERSION APLICA LOS CAMBIOS DE VERDAD.
   Si solo queres ver los numeros sin tocar nada, corre el otro archivo:
   Empenos-Borrar-Intereses-Retroactivos.sql                                     */
COMMIT TRANSACTION;
